...
class NavigationEnv(BaseEnv):
    def __init__(
        ...
        use_geodesic_feature: bool = False,
    ):
        ...
        self.use_geodesic_feature = use_geodesic_feature
        if self.use_geodesic_feature and not self.scene_manager.load_geodesics:
            raise ValueError(
                "use_geodesic_feature=True requires scene_kwargs.load_geodesics=True"
            )
