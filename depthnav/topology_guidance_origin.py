...
class TopologyGuidance:
    def __init__(
        ...
        open_score_threshold: float = 0.27,
        min_sector_width_px: int = 5,
        match_angle_threshold_deg: float = 30.0,
        match_clearance_threshold: float = 2.0,
        ema_alpha: float = 0.30,
        unmatched_decay: float = 0.86,
        closed_node_decay: float = 0.30,
        min_node_confidence: float = 0.22,
        max_staleness: int = 240,
        max_nodes: int = 10,
        score_width_norm: float = 0.18,
        score_clearance_norm: float = 3.0,
        score_support_norm: float = 8.0,
        anchor_max_angle_deg: float = 85.0,
        min_output_blend: float = 0.18,
        max_output_blend: float = 0.72,
        min_selection_score: float = 0.58,
    ) -> None:
